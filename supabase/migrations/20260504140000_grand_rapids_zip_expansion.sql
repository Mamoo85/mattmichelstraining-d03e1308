-- Expand Matt's Trade Radar coverage to include Grand Rapids metro (Kent County).
-- Statewide sources (NOAA/SPC/FEMA/Census/CFPB/FSBO scrapers) will now cover these ZIPs.
-- Safe to re-run — ON CONFLICT DO UPDATE.

DO $$
DECLARE
  all_zips TEXT[] := ARRAY[
    -- SE Michigan (existing Detroit metro)
    ...
    '49503','49504','49505','49506','49507','49508','49509','49512','49525',
    '49534','49544','49546',
    -- Wyoming, Kentwood, Walker, Grandville (Kent County suburbs)
    '49509','49548','49316','49418','49428',
    -- Ada, Caledonia, Byron Center, Rockford (outer Kent)
    '49301','49315','49341'
  ];
  v TEXT;
