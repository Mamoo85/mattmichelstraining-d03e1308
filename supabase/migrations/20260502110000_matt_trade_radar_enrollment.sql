-- 20260502110000_matt_trade_radar_enrollment.sql
-- Enrolls matt@detroitwebagent.com as active founder in all 7 trade radar verticals.
-- Fixed UUIDs — safe to run multiple times (ON CONFLICT DO UPDATE).
-- Uses 118 SE Michigan ZIPs (Wayne + Oakland + Macomb + Washtenaw counties).
...
BEGIN
  ...
  VALUES
    ('fa000001-trad-0001-0001-000000000001',
     'matt@detroitwebagent.com', 'Matt Michels', 'Detroit Web Agency',
     '+13139921219', 'roofing', se_mi_zips, true)
  ...
  INSERT INTO public.trade_radar_clients
    (id, email, contact_name, business_name, phone, vertical, zip_codes, active)
  VALUES
    ('fa000001-trad-0001-0001-000000000002',
     'matt@detroitwebagent.com', 'Matt Michels', 'Detroit Web Agency',
     '+13139921219', 'hvac', se_mi_zips, true)
  ON CONFLICT (email, vertical) DO UPDATE SET
    active = true, zip_codes = se_mi_zips, contact_name = 'Matt Michels';
  ...
  INSERT INTO public.trade_radar_clients
    (id, email, contact_name, business_name, phone, vertical, zip_codes, active)
  VALUES
    ('fa000001-trad-0001-0001-000000000003',
     'matt@detroitwebagent.com', 'Matt Michels', 'Detroit Web Agency',
     '+13139921219', 'plumbing', se_mi_zips, true)
  ON CONFLICT (email, vertical) DO UPDATE SET
    active = true, zip_codes = se_mi_zips, contact_name = 'Matt Michels';
  ...
  INSERT INTO public.trade_radar_clients
    (id, email, contact_name, business_name, phone, vertical, zip_codes, active)
  VALUES
    ('fa000001-trad-0001-0001-000000000004',
     'matt@detroitwebagent.com', 'Matt Michels', 'Detroit Web Agency',
     '+13139921219', 'electrical', se_mi_zips, true)
  ON CONFLICT (email, vertical) DO UPDATE SET
    active = true, zip_codes = se_mi_zips, contact_name = 'Matt Michels';
  ...
  INSERT INTO public.trade_radar_clients
    (id, email, contact_name, business_name, phone, vertical, zip_codes, active)
  VALUES
    ('fa000001-trad-0001-0001-000000000005',
     'matt@detroitwebagent.com', 'Matt Michels', 'Detroit Web Agency',
     '+13139921219', 'pest_control', se_mi_zips, true)
  ON CONFLICT (email, vertical) DO UPDATE SET
    active = true, zip_codes = se_mi_zips, contact_name = 'Matt Michels';
  ...
  INSERT INTO public.trade_radar_clients
    (id, email, contact_name, business_name, phone, vertical, zip_codes, active)
  VALUES
    ('fa000001-trad-0001-0001-000000000006',
     'matt@detroitwebagent.com', 'Matt Michels', 'Detroit Web Agency',
     '+13139921219', 'gutters', se_mi_zips, true)
  ON CONFLICT (email, vertical) DO UPDATE SET
    active = true, zip_codes = se_mi_zips, contact_name = 'Matt Michels';
  ...
  INSERT INTO public.trade_radar_clients
    (id, email, contact_name, business_name, phone, vertical, zip_codes, active)
  VALUES
    ('fa000001-trad-0001-0001-000000000007',
     'matt@detroitwebagent.com', 'Matt Michels', 'Detroit Web Agency',
     '+13139921219', 'painting', se_mi_zips, true)
  ON CONFLICT (email, vertical) DO UPDATE SET
    active = true, zip_codes = se_mi_zips, contact_name = 'Matt Michels';
END $$;
