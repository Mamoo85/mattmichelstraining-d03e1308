...
serve(async (req) => {
  ...
  try {
    ...
    const session = await stripe.checkout.sessions.create({
      ...
      line_items: [{ price_data: { currency: "usd", recurring: { interval: "month" }, unit_amount: 9900, product_data: { name: "AI Email Newsletter Service — $99/month", description: "AI-written monthly newsletter for your business. Up to 2,500 subscribers." } }, quantity: 1 }],
