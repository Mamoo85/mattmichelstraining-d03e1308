...
serve(async (_req) => {
  ...
  } catch (e: unknown) { const msg = e instanceof Error ? e.message : String(e); console.error("[WARRANTY] Fatal:", e); return new Response(JSON.stringify({ error: e.message }), { status: 500 }); }
});
