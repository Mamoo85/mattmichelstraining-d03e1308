...
serve(async (req) => {
  ...
  try {
    ...
    const session = await stripe.checkout.sessions.create({
      ...
      line_items: [{ price: "price_1THQr2D52tPWee46eeXsF7CP", unit_amount: 2900, product_data: { name: "AI Social Caption Pack — $29/month", description: "30 AI-written social media captions per month, delivered to your inbox." } }, quantity: 1 }],
