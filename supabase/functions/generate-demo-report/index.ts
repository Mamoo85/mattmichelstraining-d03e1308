...
const SOURCE_TO_SIGNAL: Record<string, { label: string; why: string }> = {
  ...
  yelp:             { label: "Owner-Operator",        why: "Independent contractor — open to larger opportunities" },
  indeed:           { label: "Actively Seeking Work", why: "Résumé posted on job board — actively looking" },
  apollo:           { label: "Available",             why: "Professional profile indicates availability" },
  bpl:              { label: "Verified Credential",   why: "Active state license confirmed via Bureau of Professional Licensing" },
  florida_dbpr:     { label: "Verified Credential",   why: "Active Florida state license confirmed" },
  sonar:            { label: "Available",             why: "Professional profile indicates availability" },
};
