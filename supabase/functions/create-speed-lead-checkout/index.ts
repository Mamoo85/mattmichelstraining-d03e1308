...
serve(async (req) => {
  ...
  try {
    ...
    const session = await stripe.checkout.sessions.create({
      ...
      line_items: [{ price: "price_1THQqiD52tPWee46QKMESvro", unit_amount: 3900, product_data: { name: "Speed-to-Lead SMS — $39/month", description: "Instant text response within 60 seconds of a website form fill." } }, quantity: 1 }],
