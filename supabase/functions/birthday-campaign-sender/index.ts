    ...
    for (const client of clients) {
      try {
        ...
        bcc: ["matthewmichels@gmail.com"],
              html: `<div style="font-family:sans-serif;max-width:600px;margin:0 auto;padding:20px;background:#1e293b;color:#e2e8f0;border-radius:12px;"><h2 style="color:#e8621a;">🎂 Birthday & Anniversary Campaign Templates</h2><p>Here are your ready-to-use templates. Upload your customer birthday/anniversary list to activate automated sending:</p>${content}<hr style="border-color:#334155;"><p style="color:#64748b;font-size:12px;">Powered by M² Performance — matt@mattmichelstraining.com</p><div style="margin-top:24px;padding-top:16px;border-top:1px solid #334155;display:flex;align-items:center;gap:12px;">
