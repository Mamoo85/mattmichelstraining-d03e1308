    ...
    const session = await stripe.checkout.sessions.create({
      ...
      line_items: [{
        price_data: {
          ...
          unit_amount: 2900,
          product_data: { name: "AI Sales Script Generator", description: "Custom AI-written sales scripts and objection handlers tailored to your industry." },
        },
        quantity: 1,
      }],
      metadata: { type: "sales_script_subscription", email, name: name || "", businessName, industry: industry || "" },
      success_url: `${req.headers.get("origin") || "https://www.detroitwebagent.com"}/sales-scripts?status=success`,
      cancel_url: `${req.headers.get("origin") || "https://www.detroitwebagent.com"}/sales-scripts`,
    });
