      ...
      try {
        ...
        if (RESEND_API_KEY) {
          await fetch("https://api.resend.com/emails", {
            ...
            body: JSON.stringify({
              from: "M² Permit Monitor <matt@mattmichelstraining.com>", to: [client.email],
              subject: `Permit & License Update — ${client.business_name}`,
              html: `<div style="font-family:sans-serif;max-width:600px;margin:0 auto;padding:20px;background:#1e293b;color:#e2e8f0;border-radius:12px;"><h2 style="color:#e8621a;">📋 Monthly Permit & License Digest</h2>${content}<hr style="border-color:#334155;"><p style="color:#64748b;font-size:12px;">Powered by M² Performance — matt@m2training.com</p></div>`,
            }),
          });
        }
