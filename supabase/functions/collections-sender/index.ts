      ...
      try {
        ...
        if (RESEND_API_KEY) {
          await fetch("https://api.resend.com/emails", {
            ...
            body: JSON.stringify({
              from: "M² Collections <matt@mattmichelstraining.com>", to: [client.email],
              subject: `Collection Letters Ready — ${client.business_name} (${contacts.length} accounts)`,
              html: `<div style="font-family:sans-serif;max-width:600px;margin:0 auto;padding:20px;background:#1e293b;color:#e2e8f0;border-radius:12px;"><h2 style="color:#e8621a;">💰 Collection Letters</h2><p>Here are your collection letters. Review and send to debtors:</p>${allLetters}<hr style="border-color:#334155;"><p style="color:#64748b;font-size:12px;">Powered by M² Performance — matt@m2training.com</p></div>`,
            }),
          });
        }
