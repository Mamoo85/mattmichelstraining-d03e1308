...
serve(async (req) => {
  ...
  try {
    ...
    await sb.from("afterjob_drip_clients").upsert({ email, business_name: businessName, contact_name: name || null, phone: phone || null, business_type: businessType || null, active: false }, { onConflict: "email" });
