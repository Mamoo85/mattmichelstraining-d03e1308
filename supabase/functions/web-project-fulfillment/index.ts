...
function emailRevisionAck(business: string, clientName: string): { subject: string; html: string} {
  ...
  const body = `
    ...
    <p>If you think of anything else before then, just reply to this email or text me at <a href="tel:+13139921219" style="color:#e8621a;">(313) 992-1219</a>. It's easier to batch changes together.</p>
    <p>— Matt</p>`;
  return { subject, html: wrapHtml(body, subject) };
}
