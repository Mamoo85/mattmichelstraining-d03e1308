    ...
    const session = await stripe.checkout.sessions.create({
      ...
      line_items: [{
        price_data: {
          ...
          unit_amount: 1900,
          product_data: {
            name: "FDA & CPSC Recall Alert Service",
            description: "Daily product recall monitoring matched to your industry. AI-summarized email alerts.",
          },
        },
        quantity: 1,
      }],
      metadata: {
        ...
        product_categories: (body.product_categories || []).join(","),
      },
      success_url: `${origin}/recall-alerts?success=1`,
      cancel_url: `${origin}/recall-alerts`,
    });
