...
serve(async (req) => {
  ...
  try {
    ...
    const session = await stripe.checkout.sessions.create({
      ...
      line_items: [{
        price_data: {
          ...
          unit_amount: 14900,
          product_data: {
            name: "AI Phone Answering — $149/month",
            description: "AI answers every call 24/7, qualifies leads, takes messages, schedules callbacks.",
          },
        },
        quantity: 1,
      }],
    ...
    console.error("[CREATE-PHONE-ANSWERING-CHECKOUT] Error:", e);
