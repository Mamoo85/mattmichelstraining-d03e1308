...
serve(async (req: Request) => {
  try {
    ...
    if (aiRes.ok) {
      ...
      pagesContent = `10 local SEO page outlines for ${business_name} in ${city} will be provided shortly. Please contact Matt at matt@detroitwebagent.com if you don't receive your pages within 24 hours.`;
    }
  ...
  <table width="100%" cellpadding="0" cellspacing="0" style="max-width:620px;background:#fff;border:1px solid #e0e0e0;border-radius:8px;overflow:hidden;">
    ...
    <tr><td style="padding:32px;">
      ...
      <p style="color:#555;font-size:13px;line-height:1.7;margin:0;">
        Questions? Reply to this email or reach me at <a href="mailto:matt@detroitwebagent.com" style="color:#f97316;">matt@detroitwebagent.com</a>.
      </p>
    </td></tr>
