      ...
      try {
        ...
        if (RESEND_API_KEY) {
          await fetch("https://api.resend.com/emails", {
            ...
            body: JSON.stringify({
              from: "M² Reputation <matt@detroitwebagent.com>",
        ...
        bcc: ["matthewmichels@gmail.com"],
              html: `<div style="font-family:sans-serif;max-width:600px;margin:0 auto;padding:20px;background:#1e293b;color:#e2e8f0;border-radius:12px;"><h2 style="color:#e8621a;">📊 Weekly Reputation Report</h2><p style="color:#94a3b8;">For: ${client.business_name}</p><hr style="border-color:#334155;">${reportHtml}<hr style="border-color:#334155;"><p style="color:#64748b;font-size:12px;">Powered by M2 Development — matt@detroitwebagent.com</p><div style="margin-top:24px;padding-top:16px;border-top:1px solid #334155;display:flex;align-items:center;gap:12px;">
