...
serve(async (req) => {
  ...
  try {
    ...
    const session = await stripe.checkout.sessions.create({
      ...
      line_items: [{ price: "price_1THQqxD52tPWee46FXillQoY", unit_amount: 7900, product_data: { name: "AI Blog Post Service — $79/month", description: "4 AI-written blog posts per month, emailed as ready-to-publish HTML." } }, quantity: 1 }],
