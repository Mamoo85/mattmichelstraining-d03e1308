...
/**
 * Generates native DE/ES/FR marketplace metadata for a digital product listing.
 * Uses buyer-intent phrasing for regional craft/fabric markets — not literal translation.
 */
export async function generateInternationalMetadata(
  title: string,
  description: string,
  tags: string[],
): Promise<{ de: LocaleMetadata; es: LocaleMetadata; fr: LocaleMetadata } | null> {
  const prompt = `You are a native localization and SEO specialist for digital craft marketplace products.
...
{"de":{"title":"...","description":"...","tags":["..."]},"es":{"title":"...","description":"...","tags":["..."]},"fr":{"title":"...","description":"...","tags":["..."]}}`;
  ...
  return generateJSON<{ de: LocaleMetadata; es: LocaleMetadata; fr: LocaleMetadata }>(
    prompt, null as any, 900,
  );
}
