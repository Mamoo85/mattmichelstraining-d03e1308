...
const UPSELL_MAP: Record<string, { product: string; headline: string; pitch: string; price: string; url: string; step2pitch: string }> = {
  ...
  gbp_post_pack: {
    ...
    pitch: "Your Google posts are ready. But here's the problem I see all the time: we get people clicking from Google to the website... and the website loses them. I do a full website audit ($9) that tells you exactly what's pushing people away and what to fix. Instant report, no call needed.",
    price: "$9",
  ...
  competitor_report: {
    ...
    pitch: "Your competitor report is in your inbox. You now know exactly where they're weak. The fastest way to take advantage of that is making sure your own website doesn't have the same problems. I can audit your site right now for $9 — same instant delivery.",
    price: "$9",
    url: "https://www.mattmichelstraining.com/website-audit",
