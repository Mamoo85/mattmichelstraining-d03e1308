...
const TEMPLATES: Record<string, OnboardTemplate> = {
  ...
  talent_radar_subscription: {
    subject: "🎯 Talent Radar Is Live — New License Intelligence Active",
    nextStage: "📧 Welcome Email Sent",
    body: (name) => `
      <p style="font-size:22px;font-weight:800;color:#ffffff;margin:0 0 6px;line-height:1.2">Talent Radar is live, ${name}.</p>
      <p style="color:#4a6fa5;font-size:13px;margin:0 0 24px">New-licensee intelligence, delivered daily. Michigan LARA monitored 24/7.</p>
      <div style="background:#0d1f3c;border-left:3px solid #00d4ff;padding:20px 24px;border-radius:0 8px 8px 0;margin:0 0 24px">
        <p style="color:#ffffff;font-weight:700;font-size:14px;margin:0 0 12px">WHAT YOU GET:</p>
        <p style="color:#94a3b8;font-size:13px;margin:0 0 8px">Every morning we scan Michigan's licensing database for new issuances in your vertical. Each contact is enriched with phone, email, LinkedIn, current employer, and an availability score.</p>
        <p style="color:#94a3b8;font-size:13px;margin:0">Open your dashboard to generate your first sheet. <strong style="color:#ffffff">These candidates haven't been called yet.</strong></p>
      </div>
      ${DWA_SIG}`,
  },
  talent_radar_sheet: {
    subject: "🎯 Talent Radar — Your 10-Name Sheet Is Ready",
    nextStage: "📧 Sheet Delivery Email Sent",
    body: (name) => `
      <p style="font-size:22px;font-weight:800;color:#ffffff;margin:0 0 6px;line-height:1.2">Your sheet is ready, ${name}.</p>
      <p style="color:#4a6fa5;font-size:13px;margin:0 0 24px">10 new Michigan licensees, enriched and scored.</p>
      <p style="color:#e2e8f0;font-size:14px;margin:0 0 16px">Open your dashboard to view and download your contacts. Each includes name, license number, city, phone, email, and our 1–10 availability score.</p>
      <p style="color:#94a3b8;font-size:13px;margin:0 0 20px"><strong style="color:#ffffff">ROI reminder:</strong> One CNA placement = $6,700–$10,400 in fees. This sheet cost $250.</p>
      ${DWA_SIG}`,
  },
  ...
  mortgage_radar_subscription: {
    ...
    body: (name) => `
      ...
      <p style="color:#e2e8f0;font-size:14px;margin:0 0 16px"><strong>Dashboard:</strong> Your personalized dashboard link was included in your welcome email — check your inbox for the "Mortgage Radar is Live" message. <em style="color:#64748b;font-size:12px;">(link is unique to your account)</em></p>
