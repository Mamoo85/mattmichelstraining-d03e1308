...
serve(async (req) => {
  ...
  try {
    const { email, name, businessName, industry, city, services } = await req.json();
    ...
    const session = await stripe.checkout.sessions.create({
      ...
      success_url: "https://www.mattmichelstraining.com/ai-faq-refresh?status=success",
      cancel_url: "https://www.mattmichelstraining.com/ai-faq-refresh",
    });
