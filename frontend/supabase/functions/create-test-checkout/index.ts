...
const TEST_PRODUCTS: Record<string, ProductConfig> = {
  ...
  website_audit: {
    ...
    success_url: `${SITE}/admin?test=website_audit`,
  },
  gbp_post_pack: {
    ...
    success_url: `${SITE}/admin?test=gbp_post_pack`,
  },
  competitor_report: {
    ...
    success_url: `${SITE}/admin?test=competitor_report`,
  },
  ...
  obituary_service_subscription: {
    ...
    mode: "subscription", metadata: { type: "obituary_service_subscription", email: MATT, name: "Matt Michels", funeralHomeName: "M² Test Funeral Home", phone: "+13139921219", is_test: "true" },
  ...
  sermon_prep_subscription: {
    ...
    mode: "subscription", metadata: { type: "sermon_prep_subscription", email: MATT, name: "Matt Michels", churchName: "M² Test Church", denomination: "Non-denominational", phone: "+13139921219", is_test: "true" },
  ...
  hoa_secretary_subscription: {
    ...
    mode: "subscription", metadata: { type: "hoa_secretary_subscription", email: MATT, name: "Matt Michels", hoaName: "M² Test HOA", phone: "+13139921219", is_test: "true" },
  ...
  hoa_violation_subscription: {
    ...
    mode: "subscription", metadata: { type: "hoa_violation_subscription", email: MATT, name: "Matt Michels", hoaName: "M² Test HOA", state: "MI", phone: "+13139921219", is_test: "true" },
  ...
  rfp_alerts_subscription: {
    ...
    mode: "subscription", metadata: { type: "rfp_alerts_subscription", email: MATT, name: "Matt Michels", businessName: "M2 Development", servicesOffered: "Sales training, coaching", geography: "Michigan", phone: "+13139921219", is_test: "true" },
  ...
  franchise_analyzer_subscription: {
    ...
    mode: "subscription", metadata: { type: "franchise_analyzer_subscription", email: MATT, name: "Matt Michels", businessName: "M2 Development", phone: "+13139921219", is_test: "true" },
  ...
  insurance_drip_subscription: {
    ...
    mode: "subscription", metadata: { type: "insurance_drip_subscription", email: MATT, name: "Matt Michels", businessName: "M² Insurance Agency", phone: "+13139921219", is_test: "true" },
  ...
  str_reputation_subscription: {
    ...
    mode: "subscription", metadata: { type: "str_reputation_subscription", email: MATT, name: "Matt Michels", propertyUrls: "https://airbnb.com/rooms/test", propertyCount: "1", phone: "+13139921219", is_test: "true" },
  ...
  grant_discovery_subscription: {
    ...
    mode: "subscription", metadata: { type: "grant_discovery_subscription", email: MATT, name: "Matt Michels", orgName: "M² Foundation", mission: "Helping field sales reps succeed", geography: "Michigan", causeAreas: "education, workforce development", phone: "+13139921219", is_test: "true" },
  ...
  ag_price_alerts_subscription: {
    ...
    mode: "subscription", metadata: { type: "ag_price_alerts_subscription", email: MATT, name: "Matt Michels", businessName: "M² Farms", commodities: "corn, soybeans", phone: "+13139921219", is_test: "true" },
  ...
  landlord_letters_subscription: {
    ...
    mode: "subscription", metadata: { type: "landlord_letters_subscription", email: MATT, name: "Matt Michels", state: "MI", propertyCount: "3", phone: "+13139921219", is_test: "true" },
  ...
  regulatory_monitor_subscription: {
    ...
    mode: "subscription", metadata: { type: "regulatory_monitor_subscription", email: MATT, name: "Matt Michels", businessName: "M2 Development", industry: "fitness and wellness", regulatoryBodies: "FTC, OSHA", phone: "+13139921219", is_test: "true" },
  ...
  trade_show_automation_subscription: {
    ...
    mode: "subscription", metadata: { type: "trade_show_automation_subscription", email: MATT, name: "Matt Michels", businessName: "M2 Development", phone: "+13139921219", is_test: "true" },
  ...
  price_intelligence_subscription: {
    ...
    mode: "subscription", metadata: { type: "price_intelligence_subscription", email: MATT, name: "Matt Michels", businessName: "M2 Development", competitorUrls: "https://example.com/pricing", phone: "+13139921219", is_test: "true" },
  ...
  citation_monitor_subscription: {
    ...
    mode: "subscription", metadata: { type: "citation_monitor_subscription", email: MATT, name: "Matt Michels", businessName: "M2 Development", locationCount: "1", primaryAddress: "Grosse Pointe, MI", phone: "+13139921219", is_test: "true" },
  ...
  menu_engineering_subscription: {
    ...
    mode: "subscription", metadata: { type: "menu_engineering_subscription", email: MATT, name: "Matt Michels", restaurantName: "M² Cafe", cuisineType: "American", phone: "+13139921219", is_test: "true" },
  ...
  fitness_reports_subscription: {
    ...
    mode: "subscription", metadata: { type: "fitness_reports_subscription", email: MATT, name: "Matt Michels", businessName: "M2 Development", phone: "+13139921219", is_test: "true" },
  ...
  gov_meeting_tracker_subscription: {
    ...
    mode: "subscription", metadata: { type: "gov_meeting_tracker_subscription", email: MATT, name: "Matt Michels", businessName: "M² Development LLC", targetCities: "Grosse Pointe, Detroit", keywords: "commercial, zoning, variance", phone: "+13139921219", is_test: "true" },
  ...
  storm_lead_subscription: {
    name: "TEST — Storm Damage Lead Blaster ($29/mo)",
    description: "SMS alerts to local contractors after storm events in their zip codes. $0 test.",
    mode: "subscription",
    metadata: {
      type: "storm_lead_subscription",
      email: MATT,
      business_name: "M² Test Roofing",
      phone: "+13139921219",
      trade: "roofing",
      zip_codes: "48236, 48230, 48224",
      is_test: "true",
    },
    success_url: `${SITE}/storm-leads?test=true`,
  },
  recall_alert_subscription: {
    name: "TEST — Recall Alert Service ($19/mo)",
    description: "Weekly FDA/CPSC product recall alerts matched to your industry. $0 test.",
    mode: "subscription",
    metadata: {
      type: "recall_alert_subscription",
      email: MATT,
      business_name: "M2 Development",
      phone: "+13139921219",
      industry: "fitness equipment",
      product_categories: "exercise equipment, supplements",
      is_test: "true",
    },
    success_url: `${SITE}/recall-alerts?test=true`,
  },
  permit_watch_subscription: {
    name: "TEST — Permit Watch ($29/mo)",
    description: "Weekday building permit alerts for your city and trades. $0 test.",
    mode: "subscription",
    metadata: {
    ...
    success_url: `${SITE}/permit-watch?test=true`,
  },
  speed_audit_subscription: {
    name: "TEST — Website Speed Audit ($29/mo)",
    description: "Monthly PageSpeed Insights report with actionable fixes. $0 test.",
    mode: "subscription",
    metadata: {
      type: "speed_audit_subscription",
      email: MATT,
      business_name: "M2 Development",
      website_url: "https://www.mattmichelstraining.com",
      is_test: "true",
    },
    success_url: `${SITE}/website-speed-audit?test=true`,
  },
  bedtime_story_subscription: {
    name: "TEST — AI Bedtime Stories ($4.99/mo)",
    description: "Personalized AI bedtime story emailed nightly for your child. $0 test.",
    mode: "subscription",
    metadata: {
      ...
      child_name: "Leo",
      child_age: "6",
      interests: "dinosaurs, space, superheroes",
      is_test: "true",
    },
    success_url: `${SITE}/bedtime-stories?test=true`,
  },
  crime_digest_subscription: {
    name: "TEST — Neighborhood Crime Digest ($19/mo)",
    description: "Weekly crime summary for your zip code. $0 test.",
    mode: "subscription",
    metadata: {
    ...
    success_url: `${SITE}/crime-digest?test=true`,
  },
  license_monitor_subscription: {
    name: "TEST — Business License Monitor ($25/mo)",
    description: "Monthly reminders before your business licenses expire. $0 test.",
    mode: "subscription",
    metadata: {
      ...
      phone: "+13139921219",
      state: "MI",
      license_types: "business license, contractor license",
      is_test: "true",
    },
    success_url: `${SITE}/license-monitor?test=true`,
  },

  // ── WAVE 5 HIGH-TICKET PRODUCTS ───────────────────────────────────────────
  reg_filing_monitor_subscription: {
    name: "TEST — Regulatory Filing Monitor ($497/mo)",
    description: "Daily deadline scans + AI-drafted filings for regulated industries. $0 test.",
    mode: "subscription",
    metadata: {
      type: "reg_filing_monitor_subscription",
      email: MATT,
      business_name: "M2 Development",
      phone: "+13139921219",
    ...
    success_url: `${SITE}/regulatory-filing-monitor?test=true`,
  },
  bid_intel_monitor_subscription: {
    name: "TEST — Bid Intelligence & Proposal Factory ($599/mo)",
    description: "Daily government RFP matching + AI-drafted proposal sections. $0 test.",
    mode: "subscription",
    metadata: {
      type: "bid_intel_monitor_subscription",
      email: MATT,
      business_name: "M2 Development",
      phone: "+13139921219",
      naics_codes: "611430,541611",
      geography: "Michigan",
      past_performance: "Sales training, leadership development",
      is_test: "true",
    },
    success_url: `${SITE}/bid-intelligence?test=true`,
  },
};
