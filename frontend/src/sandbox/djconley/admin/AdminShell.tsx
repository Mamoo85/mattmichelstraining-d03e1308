...
import {
  ...
  Send, Star, BarChart3, Plug, Settings, Users, Search, Bell, Sparkles, LayoutTemplate
} from "lucide-react";

const TABS = [
  { to: "/sandbox/djconley/admin",              icon: LayoutDashboard, label: "Overview",     end: true },
  { to: "/sandbox/djconley/admin/site-versions", icon: LayoutTemplate, label: "Site Versions" },
  ...
  return (
    <div className="min-h-screen flex bg-[#0b1622] text-slate-200" style={{ fontFamily: "'Plus Jakarta Sans', system-ui, sans-serif" }}>
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <div className="bg-[#27CCC0]/10 border-b border-[#27CCC0]/20 px-5 py-2 text-[11px] text-[#27CCC0]">
          Trial preview — figures shown are representative sample data. Your live SiteRadar, Missed-Call, FieldDesk, Trade Radar, TechAlert &amp; Outreach feeds connect as your tenant goes live.
        </div>
