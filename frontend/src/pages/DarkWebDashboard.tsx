...
export default function DarkWebDashboard() {
  ...
  return (
    <>
      <SEOHead
        title="Dark Web Monitor Dashboard | Detroit Web Agency"
      ...
      <div className="min-h-screen bg-gray-950 text-white">
        ...
        <div className="bg-[#0a0f1e] border-b border-[#1e2d4a]">
          <div className="max-w-5xl mx-auto px-6 py-6 flex items-center justify-between">
            <div>
              <div className="text-xs font-bold uppercase tracking-widest text-[#00d4ff] mb-1">Detroit Web Agency</div>
        ...
        <div className="border-t border-[#1e2d4a] py-6 mt-8">
          <div className="max-w-5xl mx-auto px-6 flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <span className="text-xs text-slate-500">Detroit Web Agency · matt@mattmichelstraining.com</span>
            </div>
