...
const AdminMarketingTools     = lazyRetry(() => import("@/components/admin/AdminMarketingTools"));
const AdminClientAttribution  = lazyRetry(() => import("@/components/admin/AdminClientAttribution"));
      ...
      <div className="container pt-20 pb-24 md:pb-12">
        ...
        {activeTab === "growth" && (
          <SubTabs helpId="growth" defaultTab="m2-hub" tabs={[
            ...
            { key: "marketing-tools", label: "🎬 Marketing Hub", content: <AdminMarketingTools /> },
            { key: "attribution",     label: "📊 Attribution",   content: <AdminClientAttribution /> },
