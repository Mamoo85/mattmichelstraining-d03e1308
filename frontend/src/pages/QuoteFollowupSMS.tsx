  ...
  return (
    <div className="min-h-screen bg-[#0a0a0f] text-white">
      ...
      <section className="px-4 pt-20 pb-16 text-center max-w-3xl mx-auto">
        ...
        <div className="inline-block bg-slate-800 border border-cyan-500/30 rounded-xl px-6 py-3 mb-6">
        ...
        <div className="grid sm:grid-cols-3 gap-4">
          {HOW_IT_WORKS.map(({ step, label }) => (
            <div key={step} className="bg-slate-800 border border-slate-700 rounded-xl p-5 text-center">
              <div className="w-10 h-10 bg-cyan-500 rounded-full flex items-center justify-center mx-auto mb-3 text-base font-black text-white">
                {step}
              </div>
