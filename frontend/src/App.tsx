...
const GiftShop = lazyRetry(() => import("./pages/GiftShop"));
const GiftShopCategory = lazyRetry(() => import("./pages/GiftShopCategory"));
...
const AdminFunctionStatus = lazyRetry(() => import("./pages/admin/AdminFunctionStatus"));
...
const ServicesAdmin = lazyRetry(() => import("./pages/dwa-admin/ServicesAdmin"));
const ShortsManager = lazyRetry(() => import("./pages/dwa-admin/ShortsManager"));
const MarketingHub = lazyRetry(() => import("./pages/dwa-admin/MarketingHub"));
const AdLauncher = lazyRetry(() => import("./pages/dwa-admin/AdLauncher"));
...
const AutoPodLanding = lazyRetry(() => import("./pages/AutoPodLanding"));
const SDRProduct = lazyRetry(() => import("./pages/SDRProduct"));
...
const SeoAudit = lazyRetry(() => import("./pages/SeoAudit"));
...
const OutreachClientDashboard = lazyRetry(() => import("./pages/OutreachClientDashboard"));
...
const AdminCounselSourceHealth = lazyRetry(() => import("./pages/AdminCounselSourceHealth"));
...
const AdMissedCall = lazyRetry(() => import("./pages/AdMissedCall"));
const AdSiteRadar = lazyRetry(() => import("./pages/AdSiteRadar"));
const AdDeadLeads = lazyRetry(() => import("./pages/AdDeadLeads"));
const AdTradeRadar = lazyRetry(() => import("./pages/AdTradeRadar"));
              ...
              <ErrorBoundary>
                <Suspense fallback={<PageLoader />}>
                  <div className={isDJConleyExperience ? "" : "pb-16"}>
                    ...
                    <Route path="/gng" element={<GiftShop />} />
                    <Route path="/gifts/:category" element={<GiftShopCategory />} />
                    <Route path="/gng/:category" element={<GiftShopCategory />} />
                    ...
                    <Route path="/ad/missed-call" element={<AdMissedCall />} />
                    <Route path="/ad/site-radar" element={<AdSiteRadar />} />
                    <Route path="/ad/dead-leads" element={<AdDeadLeads />} />
                    <Route path="/ad/trade-radar" element={<AdTradeRadar />} />
                    ...
                    <Route path="/my-outreach" element={<OutreachClientDashboard />} />
                    ...
                    <Route path="/admin/counsel-source-health" element={<AgencyAdminRoute><AdminCounselSourceHealth /></AgencyAdminRoute>} />
                    ...
                    <Route path="/autopod" element={<AutoPodLanding />} />
                    <Route path="/sdr-product" element={<SDRProduct />} />
                    ...
                    <Route path="/site/:slug" element={<ClientSite />} />
                     ...
                     <Route path="/assessment" element={<ProtectedRoute><Assessment /></ProtectedRoute>} />
                      ...
                      <Route path="/dwa-admin/function-status" element={<AgencyAdminRoute><AdminFunctionStatus /></AgencyAdminRoute>} />
                      ...
                      <Route path="/dwa-admin/services" element={<AgencyAdminRoute><ServicesAdmin /></AgencyAdminRoute>} />
                      <Route path="/dwa-admin/services/:product" element={<AgencyAdminRoute><ServicesAdmin /></AgencyAdminRoute>} />
                      <Route path="/dwa-admin/shorts" element={<AgencyAdminRoute><ShortsManager /></AgencyAdminRoute>} />
                      <Route path="/dwa-admin/marketing-hub" element={<AgencyAdminRoute><MarketingHub /></AgencyAdminRoute>} />
                      <Route path="/dwa-admin/ads" element={<AgencyAdminRoute><AdLauncher /></AgencyAdminRoute>} />
