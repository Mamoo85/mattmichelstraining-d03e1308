...
const PremiumProgram = () => {
  ...
  const description = c.description || "You fill out the intake. Matt reads every word. Then he builds your program from scratch — your sport, your goals, your equipment, your level. No templates. No cookie-cutter workouts. Just 20 years of experience and a proven system for building stronger, more durable athletes of any age.";
