...
const ALL_SERVICES = [
  ...
  { table: "talent_radar_clients", name: "Talent Radar (Staffing)", price: "$250-1499", priceNum: 499 },
...
export default function AdminOpsCenter() {
  ...
  const sendEmail = (email: string, businessName: string) => {
    window.open(`mailto:${email}?subject=Following up — ${businessName}&body=Hi there,%0D%0A%0D%0AJust following up on your ${businessName} account. Let me know if you need anything!%0D%0A%0D%0ABest,%0D%0AMatt Michels%0D%0AM2 Local Marketing%0D%0A(313) 992-1219`, "_blank");
  };
