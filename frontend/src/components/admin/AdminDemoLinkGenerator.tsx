...
const DEMO_GROUPS: { category: string; demos: DemoEntry[] }[] = [
  {
    category: "🎯 Active Prospects",
    demos: [
      { key: "youngblood", label: "Youngblood — Dark/Blue (recommended)", path: "/demo-youngblood", industry: "industrial automation distributor", style: "Dark industrial, high-tech", plan: "Business", priceRange: "$3,499 + $199/mo" },
      { key: "youngblood-alt1", label: "Youngblood — Steel & Fire", path: "/demo-youngblood-alt1", industry: "industrial automation company", style: "Bold white/black/red, editorial", plan: "Business", priceRange: "$3,499 + $199/mo" },
      { key: "youngblood-alt2", label: "Youngblood — Precision Grid", path: "/demo-youngblood-alt2", industry: "industrial automation company", style: "Cyber/defense dark cyan", plan: "Business", priceRange: "$3,499 + $199/mo" },
      { key: "dental", label: "Stewart's Dental — Teal/White (recommended)", path: "/demo-dental", industry: "dental practice", style: "Clean teal, clinical", plan: "Pro", priceRange: "$2,499 + $149/mo" },
      { key: "dental-alt1", label: "Stewart's Dental — Prestige (Navy/Gold)", path: "/demo-dental-alt1", industry: "dental/prosthodontic practice", style: "Luxury dark navy & gold", plan: "Pro", priceRange: "$2,499 + $149/mo" },
      { key: "dental-alt2", label: "Stewart's Dental — Nordic Wellness", path: "/demo-dental-alt2", industry: "dental practice", style: "Warm ivory/sage, minimal", plan: "Pro", priceRange: "$2,499 + $149/mo" },
    ],
  },
  {
...
export default function AdminDemoLinkGenerator() {
  const [selectedKey, setSelectedKey] = useState<string>("youngblood");
