...
const AdminClientOnboarding = () => {
  ...
  const copyInstallLink = async () => {
    await navigator.clipboard.writeText(APP_INSTALL_LINK);
      ...
      <Card>
        <CardHeader className="pb-3">
          <div className="flex items-center gap-2">
            ...
            <CardTitle className="text-sm">App Install Link</CardTitle>
          </div>
          <CardDescription className="text-[11px]">
            Copy this link and text it to clients or post it on forums. It takes them straight to the install page.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-3">
          <div className="flex items-stretch gap-1.5">
            ...
            />
            <Button size="sm" variant="secondary" onClick={copyInstallLink} className="px-3">
