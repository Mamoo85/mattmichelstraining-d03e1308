  ...
  public: {
    Tables: {
      ...
      capture_submissions: {
        ...
        Relationships: [
          {
            foreignKeyName: "capture_REDACTED"
            columns: ["tenant_id"]
            isOneToOne: false
    ...
    Functions: {
      ...
      expire_REDACTED: { Args: never; Returns: number }
