...
### TechAlert Leads
- **HOT**: Actively posting job ads on Indeed for CNA/LPN/HVAC/boiler (they're desperate)
- **WARM**: Senior care facility with 30+ beds in Metro Detroit
- **COLD**: Small company with < 5 employees (not enough hiring pain)
- Source: `medicare-staffing-intel` (nursing homes with poor staffing = pre-qualified HOT)
