...
const MerchTab = () => (
  <div>
    ...
    <motion.div
      ...
      className="bg-card border-2 border-border p-6 md:p-10 text-center mb-6"
    >
    ...
    {/* Info strip */}
    <div className="border border-border bg-secondary/30 mb-6">
      <div className="flex flex-wrap justify-center gap-6 md:gap-12 py-4 px-4">
        {[
    ...
    {/* Bottom CTA */}
    <div className="border border-border mt-6 p-6 md:p-8 text-center">
      <h3 className="text-2xl md:text-3xl font-black uppercase tracking-tighter text-foreground mb-3">
