...
const ProtocolTable = () => {
  ...
  return (
    <div>
      <SectionHeader title="Today's Protocol" timestamp="2026-03-16 — WEEK 6 / DAY 1" />
      
      {/* Table header */}
      <div className="grid grid-cols-[1fr_auto_auto_80px] md:grid-cols-[1fr_120px_80px_80px_80px] gap-2 px-3 py-2 bg-m2-zinc-800">
      ...
      {mockProtocol.map((row, i) => (
        <div
          key={i}
          className="grid grid-cols-[1fr_auto_auto_80px] md:grid-cols-[1fr_120px_80px_80px_80px] gap-2 px-3 py-3 bg-m2-surface hover:bg-m2-surface-hover transition-m2 border-b border-m2-zinc-800/50"
        >
          <div>
          ...
          <input
            ...
            className="bg-background border border-m2-zinc-700 text-right pr-2 font-mono text-primary text-sm focus:ring-1 focus:ring-primary outline-none h-8 w-full"
          />
        </div>
      ))}
