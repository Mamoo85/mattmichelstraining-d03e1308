...
const StickyMobileCTA = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 md:hidden p-3" style={{ background: "rgba(10,10,15,0.97)", backdropFilter: "blur(12px)", borderTop: "1px solid rgba(34,211,238,0.15)" }}>
      <Button asChild className="w-full py-5 font-bold text-sm rounded-lg" style={{ background: "linear-gradient(135deg, #06b6d4, #22d3ee)", color: "#020617" }}>
        <a href="sms:+13139921219">
          <Phone className="mr-2 h-4 w-4" /> Text Matt — (313) 992-1219
        </a>
      </Button>
    </div>
  );
