...
const SERVICE_TABLES = [
  ...
  { table: "obituary_clients", service: "AI Obituary Service", price: "$199/mo", lastField: null, freq: 0 },
  { table: "sermon_prep_clients", service: "Sermon Prep", price: "$79/mo", lastField: "last_sent_at", freq: 7 },
