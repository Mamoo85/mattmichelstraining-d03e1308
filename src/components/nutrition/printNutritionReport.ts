...
<body>
  <div class="header">
    <div>
      <img src="${M2_LOGO_BASE64}" alt="M2 Training" style="width:50px;height:50px;border-radius:50%;object-fit:cover;margin-bottom:8px;" />
      <h1>M2 NUTRITION REPORT</h1>
  ...
  <div class="footer">Generated by M2 Training — www.mattmichelstraining.com</div>
</body>
</html>`;
