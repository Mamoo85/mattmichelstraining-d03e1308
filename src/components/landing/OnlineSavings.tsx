...
const COMPARISONS = [
  ...
  { label: "Group speed & agility class", cost: "$150–$300/mo", note: "Generic drills, no individualization" },
  { label: "Travel team S&C coach", cost: "$100–$250/mo", note: "Often seasonal, limited contact" },
];
    ...
    <div className="bg-card shadow-m2 p-5 md:p-6">
      ...
      <div className="flex flex-col sm:flex-row gap-3 mb-4">
        ...
        <div className="flex items-center gap-2 bg-secondary/50 p-3 flex-1">
          ...
          <div>
            <span className="text-xs font-bold text-foreground block">Online — anywhere</span>
            <span className="text-[10px] text-muted-foreground">Same programs, same coach, your phone</span>
          </div>
        </div>
      </div>
