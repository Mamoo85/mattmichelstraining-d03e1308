...
const DoNotPressButton = () => (
  <section className="w-full py-3 px-4 flex justify-center">
    ...
    >
      ...
      <div
        className="relative border border-destructive/60 bg-background px-4 py-2 rounded-sm
          shadow-[0_0_10px_hsl(0_70%_50%/0.15)] hover:shadow-[0_0_16px_hsl(0_70%_50%/0.3)]
