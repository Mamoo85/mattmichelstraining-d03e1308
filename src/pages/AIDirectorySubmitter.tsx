      ...
      <div className="min-h-screen bg-[#0f0f1a] text-white">
        <section className="pt-20 pb-16 px-4">
          <div className="max-w-3xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-[#22d3ee]/15 text-[#22d3ee] text-[11px] font-bold tracking-widest uppercase mb-6"><Shield size={11} /> AI Directory Submitter</div>
            <h1 className="text-3xl sm:text-5xl font-black leading-tight mb-5">Wrong Info Online<br /><span className="text-[#22d3ee]">Costs You Customers.</span></h1>
        ...
        <section className="px-4 pb-16">
          <div className="max-w-lg mx-auto">
            <div className="bg-[#1a1a2e] border border-[#22d3ee]/30 rounded-xl p-6 text-center">
              ...
              <div className="text-4xl font-black text-[#22d3ee] mb-1">$39<span className="text-xl text-[#888] font-normal">/mo</span></div>
