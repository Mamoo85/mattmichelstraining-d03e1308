    ...
    return (
      <div className="min-h-screen bg-[#0f0f1a] text-white flex items-center justify-center px-4">
        <div className="text-center max-w-md">
          ...
          <a href="/" className="text-[#e8621a] hover:underline">← Back to homepage</a>
        </div>
      </div>
    );
  }
      ...
      <div className="min-h-screen bg-[#0f0f1a] text-white">
        ...
        <section className="pt-20 pb-16 px-4">
          <div className="max-w-4xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 bg-[#e8621a]/10 border border-[#e8621a]/30 rounded-full px-4 py-1.5 mb-6">
              <Shield size={14} className="text-[#e8621a]" />
              <span className="text-sm text-[#e8621a] font-medium">Revenue Protection System</span>
            </div>
            <h1 className="text-4xl md:text-5xl font-bold mb-5 leading-tight">
              Stop Losing Jobs<br />
              <span className="text-[#e8621a]">Every Time You Miss a Call</span>
            </h1>
            ...
            <a href="#signup" className="inline-flex items-center gap-2 bg-[#e8621a] text-white px-8 py-3.5 rounded-lg font-semibold text-lg hover:bg-[#d45a17] transition-colors">
        ...
        <section className="py-12 border-y border-white/10">
          <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 px-4 text-center">
            {STATS.map((s) => (
              <div key={s.label}>
                <div className="text-3xl font-bold text-[#e8621a] mb-1">{s.value}</div>
              ...
              {BUNDLE_FEATURES.map((f) => (
                <div key={f.title} className="bg-white/5 border border-white/10 rounded-xl p-6">
                  <div className="w-12 h-12 rounded-lg bg-[#e8621a]/15 flex items-center justify-center mb-4">
                    <f.icon size={22} className="text-[#e8621a]" />
                  </div>
        ...
        <section className="py-20 px-4">
          <div className="max-w-lg mx-auto text-center">
            <div className="bg-white/5 border border-[#e8621a]/30 rounded-2xl p-8">
              <div className="text-sm text-[#e8621a] font-medium mb-2">REVENUE PREVENTER BUNDLE</div>
              <div className="flex items-baseline justify-center gap-1 mb-2">
                <span className="text-5xl font-bold">$299</span>
                <span className="text-gray-400">/mo</span>
              </div>
              <p className="text-gray-400 text-sm mb-1">Saves if you buy separately: $392/mo</p>
              <p className="text-[#e8621a] text-sm font-medium mb-6">You save $93/mo with the bundle</p>
          ...
          <div className="max-w-md mx-auto">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <Button
                type="submit"
                disabled={loading}
                className="w-full bg-[#e8621a] hover:bg-[#d45a17] text-white py-3 text-base font-semibold"
              >
        ...
        <footer className="py-8 px-4 border-t border-white/10 text-center">
          <p className="text-gray-500 text-sm">
            M² Development · Grosse Pointe, MI · <a href="mailto:matt@mattmichelstraining.com" className="text-[#e8621a]">matt@mattmichelstraining.com</a> · (313) 806-4952
          </p>
        </footer>
      </div>
    </>
