  ...
  return (
    <div className="min-h-screen bg-white text-slate-800 px-6 py-16 max-w-3xl mx-auto">
      ...
      <section className="mb-8">
        ...
        <p className="leading-relaxed text-slate-700">
          Content generated by our services on your behalf is owned by you. Our platform, code, prompts, exercise library, training methodologies, and brand assets remain the property of M2 Development.
        </p>
      </section>
