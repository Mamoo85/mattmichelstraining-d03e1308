    ...
    <div className="min-h-screen bg-white text-slate-800 px-6 py-16 max-w-3xl mx-auto">
      ...
      <section className="mb-8">
        ...
        <p className="leading-relaxed text-slate-700 mb-3">
          By providing your phone number and consenting to SMS communications, you agree to receive automated text messages from M² Performance Training. This includes service notifications, marketing messages, and transactional alerts.
        </p>
        <ul className="list-disc pl-6 space-y-2 text-slate-700 leading-relaxed">
      ...
      <section className="mb-8">
        ...
        <p className="leading-relaxed text-slate-700">
          Content generated by our services on your behalf is owned by you. Our platform, code, prompts, and brand assets remain the property of M² Performance Training.
        </p>
      </section>
