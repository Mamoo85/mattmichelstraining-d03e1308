  ...
  return (
    <div className="min-h-screen bg-white text-slate-800 px-6 py-16 max-w-3xl mx-auto">
      ...
      <section className="mb-8">
        ...
        <p className="leading-relaxed text-slate-700">
          To the maximum extent permitted by law, M2 Development is not liable for any indirect, incidental, or consequential damages arising from your use of our services. Our total liability to you shall not exceed the amount you paid us in the 30 days prior to the claim.
        </p>
      </section>
