...
export default function AIRealEstateDrip() {
  ...
  return (
    <>
      <SEOHead title="AI Real Estate Drip Email — $79/mo | Detroit Web Agency" description="AI writes and sends monthly drip emails to your real estate leads and past clients. Stay top of mind automatically. $79/month." path="/ai-real-estate-drip" />
      <div className="min-h-screen bg-[#0a0a0f] text-white">
        <section className="pt-20 pb-16 px-4">
          <div className="max-w-3xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-[#22d3ee]/15 text-[#22d3ee] text-[11px] font-bold tracking-widest uppercase mb-6"><Home size={11} /> AI Real Estate Drip</div>
            <h1 className="text-3xl sm:text-5xl font-black leading-tight mb-5">Stay in Front of Every Lead.<br /><span className="text-[#22d3ee]">Without Typing a Word.</span></h1>
