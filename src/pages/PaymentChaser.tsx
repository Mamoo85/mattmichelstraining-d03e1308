...
import { CheckCircle, Loader2, ArrowRight, Clock, MessageSquare, Banknote, ShieldCheck } from "lucide-react";

const BENEFITS = [
  { icon: Clock, label: "Automated reminders at 3/7/14/30 days", sub: "A proven multi-touch sequence that escalates politely until you get paid" },
  { icon: MessageSquare, label: "Professional tone", sub: "AI writes firm but friendly messages — no more awkward conversations" },
  { icon: Banknote, label: "Get paid faster", sub: "Most invoices get paid within the first two reminders. Stop chasing manually." },
  { icon: ShieldCheck, label: "Reduces awkward conversations", sub: "Let the system handle the follow-up so you can focus on the next job" },
];

const STEPS = [
  { num: "1", title: "Sign up", desc: "Enter your business info and connect your invoicing system." },
  { num: "2", title: "AI chases payments", desc: "When an invoice goes overdue, AI sends professional reminders at 3, 7, 14, and 30 days." },
  { num: "3", title: "Get paid", desc: "Watch your overdue invoices shrink without a single awkward phone call." },
];
...
export default function PaymentChaser() {
    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center px-6">
        <div className="text-center max-w-sm">
          ...
          <p className="text-muted-foreground leading-relaxed">Matt will reach out within 24 hours to connect your invoicing and get payment reminders running.</p>
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setSubmitting(true);
    try {
      const { data, error } = await supabase.functions.invoke("create-payment-chaser-checkout", {
        body: { ...form },
      });
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <div className="bg-[#1e293b] text-white px-6 py-16 text-center">
        <p className="inline-block text-[11px] font-bold uppercase tracking-widest text-primary bg-primary/10 px-3 py-1 rounded-full mb-4">Late Payment Chaser</p>
        <h1 className="text-3xl font-black mb-4 leading-tight">
          Stop chasing invoices. Let AI do it for you.
        </h1>
        <p className="text-slate-300 text-sm max-w-xl mx-auto leading-relaxed mb-4">
          Automated payment reminders at 3, 7, 14, and 30 days. Professional tone, zero awkward conversations. Get paid faster.
        </p>
      ...
      <div className="max-w-3xl mx-auto px-6 py-12">
        ...
        <div className="bg-card border border-border p-5 mb-10 flex items-start gap-4">
          ...
          <p className="text-[13px] text-muted-foreground leading-relaxed">
            ...
            I built this because chasing payments is the worst part of running a business. Now AI handles the awkward follow-ups for you.
          </p>
        </div>
