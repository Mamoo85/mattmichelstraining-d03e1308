...
import { CheckCircle, Loader2, ArrowRight, Newspaper, ShieldAlert, Users, Clock } from "lucide-react";
...
const BENEFITS = [
  { icon: Newspaper, label: "Weekly industry updates", sub: "AI curates the most relevant news and trends in your industry every week" },
  { icon: ShieldAlert, label: "Safety reminders", sub: "Automated safety tips and compliance reminders keep your team sharp and protected" },
  { icon: Users, label: "Team morale boost", sub: "Shoutouts, tips, and team updates that keep your crew engaged and motivated" },
  { icon: Clock, label: "Takes zero time", sub: "AI writes, formats, and sends the newsletter — you don't touch a thing" },
];

const STEPS = [
  { num: "1", title: "Sign up", desc: "Tell us your industry and add your team's email addresses." },
  { num: "2", title: "AI writes newsletters", desc: "Every week, AI creates a professional internal newsletter for your team." },
  { num: "3", title: "Team stays informed", desc: "Your staff gets industry news, safety tips, and morale boosters — automatically." },
];
...
export default function StaffNewsletter() {
    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center px-6">
        <div className="text-center max-w-sm">
          ...
          <p className="text-muted-foreground leading-relaxed">Matt will reach out within 24 hours to get your team's email list and start your first newsletter.</p>
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setSubmitting(true);
    try {
      const { data, error } = await supabase.functions.invoke("create-staff-newsletter-checkout", {
        body: { ...form },
      });
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <div className="bg-[#1e293b] text-white px-6 py-16 text-center">
        <p className="inline-block text-[11px] font-bold uppercase tracking-widest text-primary bg-primary/10 px-3 py-1 rounded-full mb-4">Staff Internal Newsletter</p>
        <h1 className="text-3xl font-black mb-4 leading-tight">
          Keep your team informed without adding to your plate.
        </h1>
        <p className="text-slate-300 text-sm max-w-xl mx-auto leading-relaxed mb-4">
          AI writes and sends a weekly internal newsletter to your staff — industry news, safety reminders, and team morale boosters. Zero effort from you.
        </p>
      ...
      <div className="max-w-3xl mx-auto px-6 py-12">
        ...
        <div className="bg-card border border-border p-5 mb-10 flex items-start gap-4">
          ...
          <p className="text-[13px] text-muted-foreground leading-relaxed">
            ...
            I built this because keeping your team in the loop shouldn't take hours out of your week. AI handles it in minutes.
          </p>
        </div>
