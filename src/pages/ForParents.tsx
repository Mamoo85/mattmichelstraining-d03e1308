...
const INJURY_STATS = [
  { stat: "3.5 million", label: "youth sports injuries per year in the U.S.", source: "Stanford Children's Health" },
  { stat: "50%", label: "are preventable with proper training", source: "American Academy of Pediatrics" },
  { stat: "62%", label: "of organized-sport injuries happen during practice", source: "Safe Kids Worldwide" },
...
const TIMELINE = [
  {
    ...
    desc: "Movement quality, body awareness, coordination. No heavy loading — ever. Build the operating system their body will run on for the next decade.",
    action: "Youth Starter Guide — $12",
    link: "/shop",
  },
  {
    age: "14–15",
    title: "Work Capacity Phase",
    desc: "Introduce structured resistance training. Build the joints, tendons, and connective tissue BEFORE adding load. This is where most programs skip ahead — and where injuries start.",
    action: "Sport-specific guide — $9",
    link: "/shop",
  },
  {
    age: "16–17",
    title: "Strength & Power Phase",
    desc: "Now they're ready. Progressive overload, sport-specific power development, and competition prep. Their body can handle it because you didn't rush the first two phases.",
    action: "Custom program by Matt — $20",
    link: "/shop",
  },
  {
    age: "18+",
    title: "College Prep Phase",
    desc: "Peak performance programming. Matt has sent 50+ athletes to the college level. This phase is about durability under volume — because college coaches don't care how strong you were in high school if you're injured by October.",
    action: "Full training with Matt →",
    link: "/pricing",
  },
];
...
const FUNNEL_STEPS = [
  {
    ...
    desc: "Pick your sport. Get Matt's top 5 exercises with the science behind each one. $9–$12.",
    icon: BookOpen,
    cta: "Browse Guides",
    link: "/shop",
  },
  {
    ...
    desc: "Fill out the intake. Matt builds your athlete's program from scratch — goals, equipment, level. $20.",
    icon: Zap,
  ...
  },
  {
    ...
    desc: "In-person in Grosse Pointe or online. 1-on-1, small group, or team. This is where everything changes.",
    icon: GraduationCap,
    ...
    <div className="container pt-20 pb-16">
      ...
      <motion.div {...fade(0)} className="py-10 md:py-16">
        ...
        <p className="text-sm md:text-base text-muted-foreground max-w-2xl mb-6 leading-relaxed">
          Most youth training programs are built by people who learned from YouTube, not from 20 years of watching what actually breaks down in a young athlete's body. Matt Michels has trained thousands of kids. 50+ went on to compete at the college level. Zero got injured. That's not a slogan — it's a record.
        </p>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground leading-relaxed">
                Not because he's lucky. Because he understands work capacity, recovery windows, and the biomechanics of growing bodies. He teaches the WHY behind every movement — when athletes understand the reason, they execute at 100%.
              </p>
            </div>
          </div>
        </div>
      ...
      <motion.div {...fade(0.2)} className="mb-12">
        ...
        <p className="text-sm text-muted-foreground mb-6 max-w-2xl leading-relaxed">
          There's a right time for everything. Rush the process and your athlete pays for it — usually with an injury that sidelines their senior year or worse, their freshman season. Here's how Matt structures long-term development:
        </p>
      ...
      <motion.div {...fade(0.3)} className="mb-12">
        ...
        <p className="text-sm text-muted-foreground mb-6 max-w-2xl leading-relaxed">
          You don't have to commit to anything big. Start small, see results, then decide how far you want to take it.
        </p>
      ...
      <motion.div {...fade(0.4)} className="mb-12">
        <div className="bg-primary/10 border-2 border-primary/40 p-6 md:p-8 text-center">
          <h2 className="text-lg md:text-2xl font-bold text-foreground mb-2">
            Ready to protect your athlete's future?
          </h2>
          <p className="text-sm text-muted-foreground mb-6 max-w-lg mx-auto">
            Start with a $9 sport-specific guide. See how Matt thinks. Then decide if you want the full experience.
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
            ...
            <a
              href="mailto:matthewmichels4@gmail.com?subject=Parent%20Inquiry"
