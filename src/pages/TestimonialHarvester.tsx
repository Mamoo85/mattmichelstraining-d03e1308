  ...
  return (
    <div className="min-h-screen bg-[#0a0a0f] text-white">
      <div className="px-6 py-16 text-center border-b border-slate-800">
        <span className="text-[11px] font-bold uppercase tracking-widest text-cyan-500">Testimonial Harvester</span>
        ...
        <p className="text-3xl font-black text-cyan-500">$39<span className="text-sm font-normal text-slate-400">/mo</span></p>
