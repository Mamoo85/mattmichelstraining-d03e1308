...
import { CheckCircle, Loader2, ArrowRight, Mail, Heart, TrendingUp, Users } from "lucide-react";
...
const BENEFITS = [
  { icon: Mail, title: "5-Email Automated Sequence", desc: "AI writes a personalized welcome series that nurtures every new customer." },
  { icon: Heart, title: "Builds Trust from Day 1", desc: "Set the right tone immediately — before they ever think about a competitor." },
  { icon: TrendingUp, title: "Reduces Churn", desc: "Customers who feel welcomed stick around longer and spend more." },
  { icon: Users, title: "Increases Referrals", desc: "Happy onboarded customers refer friends. The drip makes that happen." },
];

export default function WelcomeDrip() {
  const [form, setForm] = useState({ name: "", businessName: "", email: "", industry: "" });
    ...
    return (
      <div className="min-h-screen bg-[#0a0a0f] flex items-center justify-center px-6">
        <div className="text-center max-w-sm">
          ...
          <p className="text-slate-400 leading-relaxed">Your 7-day free trial is active. Matt will reach out within 24 hours to build your welcome sequence.</p>
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    try {
      const { data, error: fnError } = await supabase.functions.invoke("create-welcome-drip-checkout", {
        body: { ...form },
      });
    ...
    <div className="min-h-screen bg-[#0a0a0f] text-white">
      ...
      <div className="bg-[#0a0a0f] px-6 py-16 text-center border-b border-slate-800">
        ...
        <h1 className="text-3xl md:text-4xl font-black mb-4 leading-tight">
          Turn new customers into loyal fans — automatically.
        </h1>
        <p className="text-2xl font-black text-cyan-500 mb-2">$49<span className="text-sm font-normal text-slate-400">/mo</span></p>
      ...
      <div className="max-w-3xl mx-auto px-6 py-12">
        ...
        <div className="mb-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            {[
              { step: "1", title: "Tell Us Your Industry", desc: "We tailor the entire sequence to your business type." },
              { step: "2", title: "AI Writes 5 Emails", desc: "Welcome, value, tips, social proof, and a referral ask." },
              { step: "3", title: "Customers Get Nurtured", desc: "Every new signup gets the full sequence automatically." },
            ].map((s) => (
