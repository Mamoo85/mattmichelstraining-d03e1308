      ...
      <div className="min-h-screen bg-[#0f0f1a] text-white">
        <section className="pt-20 pb-16 px-4">
          <div className="max-w-3xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-[#22d3ee]/15 text-[#22d3ee] text-[11px] font-bold tracking-widest uppercase mb-6"><Shield size={11} /> AI Price Monitor</div>
            <h1 className="text-3xl sm:text-5xl font-black leading-tight mb-5">Know What Your Competitors<br /><span className="text-[#22d3ee]">Are Charging.</span></h1>
