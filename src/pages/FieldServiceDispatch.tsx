...
const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    price: "$149",
    unit: "/mo",
    oneLiner: "Industry expansion + regulatory intelligence — early-mover signals",
    Icon: TrendingUp,
    category: "intelligence",
    industries: ["all"],
    color: "#a78bfa",
    colorBg: "#7c3aed20",
    features: ["New permits + expansion detection", "Hiring wave signals", "Regulatory change alerts", "1–10 confidence scoring per signal", "Early-mover intelligence", "Daily digest + dashboard"],
    stats: [{ value: "$149", label: "/mo" }, { value: "1–10", label: "Confidence" }, { value: "Daily", label: "Refresh" }],
    steps: [
      { Icon: TrendingUp, title: "Detect", desc: "New permits, expansions, hiring waves" },
      { Icon: Activity, title: "Score", desc: "1–10 confidence per signal" },
      { Icon: Bell, title: "Alert", desc: "Early-mover intelligence" },
    ],
    cta: "Add Growth Radar",
