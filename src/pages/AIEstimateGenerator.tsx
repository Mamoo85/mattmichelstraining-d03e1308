...
import { CheckCircle, Loader2, ArrowRight, FileText, DollarSign, Send, Trophy } from "lucide-react";
...
const BENEFITS = [
  { icon: FileText, label: "Professional estimates in minutes", sub: "AI generates clean, branded estimates based on your services and pricing" },
  { icon: DollarSign, label: "Consistent pricing", sub: "No more guessing or undercutting yourself — every estimate follows your pricing rules" },
  { icon: Send, label: "Email to prospects instantly", sub: "Send professional estimates to leads the moment they request one" },
  { icon: Trophy, label: "Win more jobs", sub: "Faster response time with professional estimates means you close more deals" },
];

const STEPS = [
  { num: "1", title: "Sign up", desc: "Enter your business info, services, and base pricing." },
  { num: "2", title: "AI builds estimates", desc: "Describe the job and AI generates a professional estimate in minutes." },
  { num: "3", title: "Send and close", desc: "Email the estimate directly to the prospect and win more jobs." },
];
...
export default function AIEstimateGenerator() {
    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center px-6">
        <div className="text-center max-w-sm">
          ...
          <p className="text-muted-foreground leading-relaxed">Matt will reach out within 24 hours to configure your estimate templates and pricing.</p>
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setSubmitting(true);
    try {
      const { data, error } = await supabase.functions.invoke("create-estimate-generator-checkout", {
        body: { ...form },
      });
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <div className="bg-[#1e293b] text-white px-6 py-16 text-center">
        <p className="inline-block text-[11px] font-bold uppercase tracking-widest text-primary bg-primary/10 px-3 py-1 rounded-full mb-4">AI Estimate Generator</p>
        <h1 className="text-3xl font-black mb-4 leading-tight">
          Stop losing jobs because your estimates take too long.
        </h1>
        <p className="text-slate-300 text-sm max-w-xl mx-auto leading-relaxed mb-4">
          AI generates professional, branded estimates in minutes — not hours. Consistent pricing, instant delivery, more closed deals.
        </p>
        <p className="text-2xl font-black text-primary">$49<span className="text-sm font-normal text-slate-400">/month</span></p>
      ...
      <div className="max-w-3xl mx-auto px-6 py-12">
        ...
        <div className="bg-card border border-border p-6 mb-10">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            >
              ...
              {submitting ? "Processing..." : "Start Free Trial — $49/mo"}
            </button>
        ...
        <div className="bg-card border border-border p-5 mb-10 flex items-start gap-4">
          ...
          <p className="text-[13px] text-muted-foreground leading-relaxed">
            ...
            I built this because the fastest estimate usually wins the job. AI makes you the fastest every time.
          </p>
        </div>
