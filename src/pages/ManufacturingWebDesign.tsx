...
const PLANS = [
  ...
  },
  {
    ...
    setup: "$1,499",
    monthly: "$99/mo",
    description: "Mid-size manufacturers needing CRM and lead routing.",
    includes: [
      "Everything in Standard",
      "CRM integration (HubSpot/Salesforce)",
      "Inquiry routing by product line",
...
const FAQS = [
  ...
  { q: "How long does the build take?", a: "Standard sites are typically live within 2 weeks. Professional and Business tiers with catalog and RFQ systems take 3–5 weeks depending on scope." },
];
