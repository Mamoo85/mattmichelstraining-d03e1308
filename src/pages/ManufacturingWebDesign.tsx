...
const PLANS = [
  {
    ...
    setup: "$499",
    monthly: "$49/mo",
    description: "Fast, professional site for small shops.",
    includes: [
      "5-page website",
  ...
  },
  {
    ...
    includes: [
      ...
      "CRM webhook integration (HubSpot, Salesforce, etc.)",
      "Inquiry forms routed by product line",
  ...
  },
  {
    ...
    setup: "$3,499",
    monthly: "$199/mo",
    description: "Full product catalog, RFQ system, and dealer locator.",
    includes: [
      "Everything in Professional",
      "Product/service catalog with specs & PDFs",
      "RFQ (Request for Quote) form system",
      "Dealer/distributor locator via Google Maps",
...
const FEATURES = [
  { icon: Package, label: "Product catalog", sub: "Showcase your full line with specs, photos, and downloads" },
  { icon: FileText, label: "RFQ forms", sub: "Let buyers request quotes directly from your site" },
  { icon: MapPin, label: "Dealer locator", sub: "Help customers find your distributors fast" },
  { icon: Search, label: "SEO optimized", sub: "Rank for the searches your buyers are already making" },
  { icon: Smartphone, label: "Mobile-first", sub: "Works perfectly on every device, every screen size" },
  { icon: BarChart2, label: "Lead tracking", sub: "Know exactly where your inquiries are coming from" },
];

const FAQS = [
  { q: "What makes a manufacturing website different from a regular business site?", a: "Manufacturers need product catalogs with specs and downloadable PDFs, RFQ forms that route inquiries to the right product manager, and dealer/distributor locators. We build these features in — not as afterthoughts." },
  { q: "Do I need to provide all the content?", a: "We handle copywriting, SEO structure, and design. You provide product info, photos, and company details — we turn it into a site that sells." },
  { q: "How long does the build take?", a: "Standard sites are live within 10–14 days. Professional tier takes 2–3 weeks. Business tier with catalog, RFQ, and dealer locator takes 3–4 weeks depending on scope." },
];

export default function ManufacturingWebDesign() {
    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center px-6">
        <div className="text-center max-w-sm">
          ...
          <p className="text-muted-foreground leading-relaxed">Matt will reach out within 24 hours to kick off your manufacturing website build.</p>
        ...
        <div className="max-w-3xl mx-auto px-6 py-12">
            ...
            <form onSubmit={handleSubmit} className="space-y-3">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div>
                  ...
                  <input value={form.business_name} onChange={e => setForm(f => ({...f, business_name: e.target.value}))} required placeholder="Acme Manufacturing Co."
                ...
                <div>
                  ...
                  <input value={form.business_type} onChange={e => setForm(f => ({...f, business_type: e.target.value}))} placeholder="Manufacturer"
                    className="w-full bg-background border border-border px-3 py-2.5 text-sm focus:ring-1 focus:ring-primary outline-none" />
                </div>
                <div>
          ...
          <div className="bg-card border border-border p-5 mb-10 flex items-start gap-4">
            ...
            <p className="text-[13px] text-muted-foreground leading-relaxed">
              <span className="font-bold text-foreground">I'm Matt Michels — Grosse Pointe, MI.</span> I've worked with Michigan manufacturers who were losing RFQ opportunities to competitors with better websites. I fix that.
            </p>
          </div>
