...
import { CheckCircle, Loader2, ArrowRight, Phone, MessageSquare, Shield, RefreshCw } from "lucide-react";
...
const BENEFITS = [
  { icon: Phone, title: "Cold Call Openers", desc: "AI-written openers that get past gatekeepers and start real conversations." },
  { icon: MessageSquare, title: "Follow-Up Scripts", desc: "Know exactly what to say on the second, third, and fourth touch." },
  { icon: Shield, title: "Objection Handling", desc: "Pre-built responses to the most common pushbacks in your industry." },
  { icon: RefreshCw, title: "Updated Monthly", desc: "Fresh scripts every month so your pitch never goes stale." },
];
...
export default function SalesScripts() {
    ...
    return (
      <div className="min-h-screen bg-slate-900 flex items-center justify-center px-6">
        <div className="text-center max-w-sm">
          ...
          <p className="text-slate-400 leading-relaxed">Your 7-day free trial is active. Your first script pack will be delivered shortly.</p>
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    try {
      const { data, error: fnError } = await supabase.functions.invoke("create-sales-script-checkout", {
        body: { ...form },
      });
    ...
    <div className="min-h-screen bg-slate-900 text-white">
      ...
      <div className="bg-slate-900 px-6 py-16 text-center border-b border-slate-800">
        ...
        <h1 className="text-3xl md:text-4xl font-black mb-4 leading-tight">
          Never wing a sales call again.
        </h1>
        <p className="text-2xl font-black text-orange-500 mb-2">$29<span className="text-sm font-normal text-slate-400">/mo</span></p>
      ...
      <div className="max-w-3xl mx-auto px-6 py-12">
        ...
        <div className="mb-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            {[
              { step: "1", title: "Pick Your Industry", desc: "AI tailors every script to your specific business and market." },
              { step: "2", title: "Get Your Script Pack", desc: "Cold call openers, follow-ups, voicemails, and objection handlers." },
              { step: "3", title: "Close More Deals", desc: "Updated monthly so you always have fresh, proven language." },
            ].map((s) => (
