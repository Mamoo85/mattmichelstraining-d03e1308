...
export default function AITruckingDocs() {
  ...
  return (
    <>
      <SEOHead title="AI Trucking & Fleet Documents — $99/mo | Detroit Web Agency" description="AI writes safety checklists, driver comms, BOL templates, and HOS reminders for owner-operators and small trucking fleets. $99/month." path="/ai-trucking-docs" />
      <div className="min-h-screen bg-[#0f0f1a] text-white">
        <section className="pt-20 pb-16 px-4">
          <div className="max-w-3xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-[#22d3ee]/15 text-[#22d3ee] text-[11px] font-bold tracking-widest uppercase mb-6"><Truck size={11} /> AI Trucking & Fleet Docs</div>
            <h1 className="text-3xl sm:text-5xl font-black leading-tight mb-5">Less Paperwork.<br /><span className="text-[#22d3ee]">More Miles.</span></h1>
