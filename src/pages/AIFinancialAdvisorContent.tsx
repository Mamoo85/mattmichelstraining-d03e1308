...
export default function AIFinancialAdvisorContent() {
  ...
  return (
    <>
      <SEOHead title="AI Content for Financial Advisors — $149/mo | Detroit Web Agency" description="AI writes compliance-aware newsletters, LinkedIn posts, and educational content for RIAs and financial planners. $149/month." path="/ai-financial-advisor-content" />
      <div className="min-h-screen bg-[#0f0f1a] text-white">
        <section className="pt-20 pb-16 px-4">
          <div className="max-w-3xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-[#22d3ee]/15 text-[#22d3ee] text-[11px] font-bold tracking-widest uppercase mb-6"><TrendingUp size={11} /> AI Financial Advisor Content</div>
            <h1 className="text-3xl sm:text-5xl font-black leading-tight mb-5">Stay in Front of Clients.<br /><span className="text-[#22d3ee]">Without Compliance Headaches.</span></h1>
