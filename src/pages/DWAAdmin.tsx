...
type Tab = "overview" | "clients" | "jobs" | "assets" | "contracts" | "import" | "command" | "board" | "playbook" | "strategy" | "medicare" | "industrial" | "growth" | "labs" | "sales-guide" | "lara-health" | "cross-sell" | "postcards" | "agency-outreach" | "demand-radar" | "supplier-outreach";
  ...
  return (
    <div className="min-h-screen bg-[#0a1628] text-white">
      ...
      <main className="max-w-7xl mx-auto px-3 sm:px-6 pt-28 pb-12">
        ...
        {activeTab === "playbook" && (
          <Suspense fallback={<div className="text-white/40 text-sm">Loading playbook…</div>}>
            <DWAPlaybook />
          </Suspense>
        )}

        {activeTab === "strategy" && (
          <Suspense fallback={<div className="text-white/40 text-sm">Loading strategy…</div>}>
            <DWAStrategy />
          </Suspense>
        )}

        {activeTab === "medicare" && (
          <Suspense fallback={<div className="text-white/40 text-sm">Loading client intel…</div>}>
            <AdminMedicareIntel />
          </Suspense>
        )}

        {activeTab === "industrial" && (
          <Suspense fallback={<div className="text-white/40 text-sm">Loading industrial intel…</div>}>
        ...
        {activeTab === "demand-radar" && (
          <Suspense fallback={<div className="text-white/40 text-sm">Loading Demand Radar...</div>}>
            <AdminDemandRadar />
          </Suspense>
        )}
        {activeTab === "supplier-outreach" && (
          <Suspense fallback={<div className="text-white/40 text-sm">Loading Supplier Outreach...</div>}>
            <SupplierOutreachGenerator />
          </Suspense>
        )}
      </main>
    </div>
