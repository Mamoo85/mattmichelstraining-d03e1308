...
export default function AIPropertyManagement() {
  ...
  return (
    <>
      <SEOHead title="AI Property Management Automation — $99/mo | Detroit Web Agency" description="AI writes tenant notices, lease renewal letters, maintenance follow-ups, and late payment reminders for landlords and property managers. $99/month." path="/ai-property-management" />
      <div className="min-h-screen bg-[#0f0f1a] text-white">
        <section className="pt-20 pb-16 px-4">
          <div className="max-w-3xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-[#22d3ee]/15 text-[#22d3ee] text-[11px] font-bold tracking-widest uppercase mb-6"><Building2 size={11} /> AI Property Management</div>
            <h1 className="text-3xl sm:text-5xl font-black leading-tight mb-5">Landlord Paperwork.<br /><span className="text-[#22d3ee]">Done by AI.</span></h1>
