  ...
  return (
    <div className="min-h-screen bg-[#0a0a0f] text-white">
      <div className="px-6 py-16 text-center border-b border-slate-800">
        <span className="text-[11px] font-bold uppercase tracking-widest text-cyan-500">AI Annual Business Review</span>
        ...
        <p className="text-3xl font-black text-cyan-500">$79<span className="text-sm font-normal text-slate-400">/mo</span></p>
      ...
      <div className="max-w-3xl mx-auto px-6 py-12">
        ...
        <p className="text-[12px] text-slate-500 text-center">
          Questions? (313) 992-1219 &middot; <a href="mailto:matt@mattmichelstraining.com" className="text-cyan-500">matt@mattmichelstraining.com</a>
        </p>
      </div>
    </div>
  );
