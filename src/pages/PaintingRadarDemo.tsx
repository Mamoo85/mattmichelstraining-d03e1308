...
const DEMO_LEADS = [
  { score: 9, signal: "Painting Signal A", address: "14823 Woodward Ave", city: "Detroit", zip: "48203", detail: "Sample signal detail for demo purposes. This is what real leads look like.", opener: "Hi, we noticed activity at your property that suggests you may need painting services soon." },
  { score: 7, signal: "Painting Signal B", address: "2201 Pontiac Lake Rd", city: "Waterford", zip: "48328", detail: "Second sample signal — different trigger, same exclusive data source.", opener: "We've been helping neighbors on your street — wanted to reach out before you had to search." },
  { score: 8, signal: "Painting Signal C", address: "38500 Van Dyke Ave", city: "Sterling Heights", zip: "48312", detail: "Third sample signal showing variety of trigger events we monitor.", opener: "Recent data in your ZIP suggests this may be the right time — happy to give you a free estimate." },
];

export default function PaintingRadarDemo() {
  ...
  return (
    <div className="min-h-screen bg-[#0a1628] text-white">
      <nav className="border-b border-[#1e3a5f] px-6 py-4 flex items-center justify-between max-w-5xl mx-auto">
        ...
        <Button onClick={() => navigate("/painting-radar")} size="sm" className="bg-[#00d4ff] text-[#0a1628] font-bold">
          Get Real Leads
        </Button>
      </nav>
      <div className="max-w-3xl mx-auto px-6 py-16">
        <Badge className="bg-[#00d4ff]/10 text-[#00d4ff] border-[#00d4ff]/30 mb-4">Sample Report · Demo Data</Badge>
        <h1 className="text-3xl font-extrabold mb-2">Painting Radar — Sample Lead Report</h1>
        ...
        <div className="mt-12 text-center">
          ...
          <Button onClick={() => navigate("/painting-radar")} className="bg-[#00d4ff] text-[#0a1628] font-bold text-lg px-8 py-3">
