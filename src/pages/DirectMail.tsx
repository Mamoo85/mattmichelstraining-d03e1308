...
import { CheckCircle, Loader2, ArrowRight, FileText, Printer, MapPin, Sparkles } from "lucide-react";
...
const BENEFITS = [
  { icon: FileText, title: "Monthly Postcard Copy", desc: "AI writes fresh direct mail copy every month, tailored to your business." },
  { icon: Printer, title: "Print-Ready", desc: "Formatted for standard postcard sizes — hand it to your printer and go." },
  { icon: MapPin, title: "Local Targeting", desc: "Copy references your city, neighborhood, and local events for relevance." },
  { icon: Sparkles, title: "Stand Out in the Mailbox", desc: "While everyone's fighting for inbox space, you own the physical mailbox." },
];
...
export default function DirectMail() {
    ...
    return (
      <div className="min-h-screen bg-[#0a0a0f] flex items-center justify-center px-6">
        <div className="text-center max-w-sm">
          ...
          <p className="text-slate-400 leading-relaxed">Your 7-day free trial is active. Your first direct mail copy will be delivered shortly.</p>
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    try {
      const { data, error: fnError } = await supabase.functions.invoke("create-direct-mail-checkout", {
        body: { ...form },
      });
    ...
    <div className="min-h-screen bg-[#0a0a0f] text-white">
      ...
      <div className="bg-[#0a0a0f] px-6 py-16 text-center border-b border-slate-800">
        ...
        <h1 className="text-3xl md:text-4xl font-black mb-4 leading-tight">
          Direct mail that actually gets read.
        </h1>
      ...
      <div className="max-w-3xl mx-auto px-6 py-12">
        ...
        <div className="mb-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            {[
              { step: "1", title: "Share Your Details", desc: "Industry, city, and what you want to promote — we handle the rest." },
              { step: "2", title: "Get Monthly Copy", desc: "AI writes postcard headlines, body copy, and calls-to-action." },
              { step: "3", title: "Print & Mail", desc: "Hand the copy to your printer. Postcards go out. Phones ring." },
            ].map((s) => (
