...
export default function PaymentSuccess() {
  ...
  const isGeneric = !isMaintenance && !isWebsite;
      ...
      <div className="min-h-screen bg-[#0a1628] text-white px-5 py-16 sm:py-24">
        <div className="max-w-xl mx-auto text-center">
          ...
          <p className="mt-4 text-slate-300 text-base sm:text-lg leading-relaxed">
            You're all set. Matt will follow up within 24 hours to get everything configured and running for you.
          </p>
          <div className="mt-8 border border-[#1e3a5f] bg-[#0c1a2e] rounded-xl p-5 text-left">
            ...
            <ol className="mt-3 space-y-2 text-slate-200 text-[15px] list-decimal list-inside">
              <li>Stripe receipt lands in your inbox now</li>
              <li>Matt reviews and activates your account within 24 hours</li>
              <li>You'll get an email or text with next steps</li>
            </ol>
          </div>
