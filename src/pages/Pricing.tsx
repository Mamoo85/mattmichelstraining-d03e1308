...
const TIER_CARDS: {
...
}[] = [
  {
    ...
    icon: Zap,
    features: [
      "Full exercise video library (search by sport, body part, or goal)",
      "10 ready-to-go daily workouts",
      "Monthly challenges & community leaderboard",
      "Monthly Focus Plan from Coach Matt",
      "Workout logging & progress tracking",
    ],
    cta: "Start Basic",
    subtitle: "Explore the library and start training on your own terms.",
  },
  {
    key: "foundation",
    icon: Star,
  ...
  },
  {
    ...
    features: [
      ...
      "Full-season training plans (in-season & off-season)",
      "Program multiple athletes or an entire team at once",
      "Roster management & bulk workout assignment",
      "Built for coaches, parents of multi-sport athletes, and competitive teams",
    ],
    cta: "Go Team/Elite",
