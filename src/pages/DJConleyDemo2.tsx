  ...
  return (
    ...
    >
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
          ...
          <div>
            ...
            <p style={{ margin: 0, fontSize: 11, color: "#64748b", letterSpacing: "0.1em", textTransform: "uppercase" }}>
              Field Operations Command Center
            </p>
          </div>
        </div>
        <div style={{ textAlign: "right" }}>
          <p style={{ margin: 0, fontSize: 11, color: "#00d4ff", fontWeight: 700, letterSpacing: "0.15em", textTransform: "uppercase" }}>
      ...
      <div style={{ maxWidth: kiosk ? 1400 : 1100, margin: "0 auto", padding: kiosk ? "20px 24px" : "24px 20px" }}>
        {/* ── Cinematic Sizzle Reel ── */}
        <SizzleHero src="/videos/djconley-sizzle.mp4" kiosk={kiosk} companyName="D.J. Conley" />
        ...
        {/* ── Missed-Call Catch — After-Hours Lead Capture ── */}
        <MissedCallPanel />

        {/* ── Buyer Radar — RFP signals ── */}
        <BuyerRadarPanel city="Troy" buyerRadarValue="Stellantis truck plant just posted a $2.4M boiler retrofit RFP on MITN.info. Buyer Radar would have texted Pat the moment it went live." />
        ...
        >
            ...
            {(["dispatch", "map"] as const).map((tab) => (
              <button
                ...
                style={{
                  ...
                  background: activeSection === tab ? "#060e1a" : "transparent",
                  color: activeSection === tab ? "#00d4ff" : "#64748b",
                  borderBottom: activeSection === tab ? "2px solid #00d4ff" : "2px solid transparent",
                }}
              >
          ...
          <div style={{ maxHeight: 480, overflowY: "auto" }}>
            {activeSection === "dispatch" ? <DispatchBoard clientId="demo" /> : <TechMap clientId="demo" />}
          </div>
        </div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 12, marginBottom: 20 }}>
          {[
            ...
            <div
              key={p.name}
              style={{
                background: p.bad ? "#0a1628" : "#10b98110",
                border: `2px solid ${p.bad ? "#1e3a5f" : "#10b981"}`,
                borderRadius: 14,
                padding: "18px",
                textAlign: "center",
              }}
            >
              {!p.bad && (
                <p style={{ margin: "0 0 6px", fontSize: 10, color: "#10b981", fontWeight: 800, letterSpacing: "0.15em", textTransform: "uppercase" }}>
                  ✓ Best Value
                </p>
              )}
        ...
        <div
          style={{
            background: "linear-gradient(135deg, #10b98115, #00d4ff10)",
        ...
        >
          <div style={{ display: "flex", alignItems: "flex-start", gap: 20, flexWrap: "wrap" }}>
            <div style={{ flex: 1, minWidth: 280 }}>
              <p style={{ margin: "0 0 4px", fontSize: 11, color: "#dc2626", fontWeight: 800, letterSpacing: "0.15em", textTransform: "uppercase" }}>
                🚨 Missing From Your Current Site
              </p>
              ...
              <p style={{ margin: "0 0 14px", fontSize: 13, color: "#94a3b8", lineHeight: 1.7 }}>
                A plant manager Googles "emergency boiler repair Troy MI" at 2am. They land on djconley.com. There's no big red emergency button. No
                click-to-call. No "we answer 24/7" front and center. They scroll for 4 seconds, don't find it, and call the competitor who does have it.
              </p>
              ...
              <p style={{ margin: 0, fontSize: 12, color: "#64748b" }}>
                Detroit Web Agency adds a floating "🚨 Emergency Service" button to your site that pulses on mobile. One tap calls the shop directly.{" "}
                <strong style={{ color: "#fff" }}>This is included with your website build.</strong>
              </p>
            </div>
        ...
        >
          <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: 20, flexWrap: "wrap" }}>
            <div style={{ flex: 1, minWidth: 280 }}>
              <p style={{ margin: "0 0 6px", fontSize: 11, color: "#00d4ff", fontWeight: 800, letterSpacing: "0.15em", textTransform: "uppercase" }}>
                ⚡ Talent Radar — $99/mo Add-On
              </p>
              <p style={{ margin: "0 0 10px", fontWeight: 800, fontSize: 16 }}>
                Need to hire a licensed boiler op?
                <br />
                We know before anyone else.
              </p>
              <p style={{ margin: 0, fontSize: 13, color: "#94a3b8", lineHeight: 1.7 }}>
                Michigan MIOSHA publishes every licensed boiler operator in the state. The day a new license is issued — a tech just became available
                — we alert you first. No other hiring tool watches this.
              </p>
            </div>
            <div style={{ flex: "0 0 auto" }}>
              <p style={{ margin: "0 0 8px", fontSize: 11, color: "#64748b", fontWeight: 600 }}>Available right now near Troy:</p>
