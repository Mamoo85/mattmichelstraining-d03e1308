...
export default function AllServices() {
  return (
    <div className="min-h-screen text-white" style={{ background: "#0a0a0f" }}>
      <SEOHead title="All Services — Detroit Web Agency" description="The full Detroit Web Agency service stack: FieldDesk CRM, Talent Radar hiring monitor, SiteRadar visitor intel, SEO Guard, dead lead reactivation, and more." path="/all-services" />
      {/* Hero */}
