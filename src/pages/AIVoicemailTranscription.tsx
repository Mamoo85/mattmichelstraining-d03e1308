      ...
      <div className="min-h-screen bg-[#0f0f1a] text-white">
        <section className="pt-20 pb-16 px-4">
          <div className="max-w-3xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-[#22d3ee]/15 text-[#22d3ee] text-[11px] font-bold tracking-widest uppercase mb-6"><Voicemail size={11} /> AI Voicemail</div>
            <h1 className="text-3xl sm:text-5xl font-black leading-tight mb-5">Stop Listening to<br /><span className="text-[#22d3ee]">Rambling Voicemails.</span></h1>
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center items-center">
              <button className="bg-[#22d3ee] hover:bg-[#06b6d4] text-white text-base px-8 py-4 font-bold rounded-xl flex items-center gap-2" onClick={() => document.getElementById("signup-form")?.scrollIntoView({ behavior: "smooth" })}>Start Free 7-Day Trial <ArrowRight size={16} /></button>
