...
import { CheckCircle, Loader2, ArrowRight, MessageCircle, Bot, TrendingUp, Shield } from "lucide-react";

const BENEFITS = [
  { icon: MessageCircle, label: "Never miss a question", sub: "AI monitors your Google Business Profile Q&A section 24/7" },
  { icon: Bot, label: "Professional AI answers", sub: "Every question gets a helpful, on-brand answer within hours — not weeks" },
  { icon: TrendingUp, label: "Improves Google ranking", sub: "Active Q&A sections signal to Google that your business is engaged and trustworthy" },
  { icon: Shield, label: "Builds trust with searchers", sub: "People searching for your business see answered questions and feel confident choosing you" },
];

const STEPS = [
  { num: "1", title: "Sign up", desc: "Connect your Google Business Profile and we start monitoring." },
  { num: "2", title: "AI answers questions", desc: "When someone asks a question, AI drafts a professional, helpful answer." },
  { num: "3", title: "Build trust", desc: "Searchers see a business that responds — and choose you over competitors." },
];

export default function GoogleQAManager() {
    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center px-6">
        <div className="text-center max-w-sm">
          ...
          <p className="text-muted-foreground leading-relaxed">Matt will reach out within 24 hours to connect your Google Business Profile.</p>
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setSubmitting(true);
    try {
      const { data, error } = await supabase.functions.invoke("create-google-qa-checkout", {
        body: { ...form },
      });
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <div className="bg-[#1e293b] text-white px-6 py-16 text-center">
        <p className="inline-block text-[11px] font-bold uppercase tracking-widest text-primary bg-primary/10 px-3 py-1 rounded-full mb-4">AI Google Q&A Manager</p>
        <h1 className="text-3xl font-black mb-4 leading-tight">
          Never leave a Google question unanswered again.
        </h1>
        <p className="text-slate-300 text-sm max-w-xl mx-auto leading-relaxed mb-4">
          AI monitors your Google Business Profile Q&A and posts professional answers automatically. Build trust, improve rankings, win more customers.
        </p>
      ...
      <div className="max-w-3xl mx-auto px-6 py-12">
        ...
        <div className="bg-card border border-border p-5 mb-10 flex items-start gap-4">
          ...
          <p className="text-[13px] text-muted-foreground leading-relaxed">
            ...
            I built this because most businesses have unanswered questions sitting on their Google profile right now. That's lost trust and lost customers.
          </p>
        </div>
