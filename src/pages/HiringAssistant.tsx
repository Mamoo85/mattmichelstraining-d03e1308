...
import { CheckCircle, Loader2, ArrowRight, Brain, BarChart3, Mail, Clock } from "lucide-react";
...
const BENEFITS = [
  { icon: Brain, title: "AI Screens Resumes", desc: "Every application gets reviewed by AI against your job requirements instantly." },
  { icon: BarChart3, title: "Scores Candidates 1-10", desc: "Clear ranking so you know exactly who to call first." },
  { icon: Mail, title: "Auto-Emails Qualified Applicants", desc: "Top candidates get a response immediately — before they accept another offer." },
  { icon: Clock, title: "Saves Hours Per Hire", desc: "Stop reading 50 resumes. AI narrows it down to the top 5 in minutes." },
];

export default function HiringAssistant() {
  const [form, setForm] = useState({ name: "", businessName: "", email: "", industry: "", city: "" });
    ...
    return (
      <div className="min-h-screen bg-[#0a0a0f] flex items-center justify-center px-6">
        <div className="text-center max-w-sm">
          ...
          <p className="text-slate-400 leading-relaxed">Your 7-day free trial is active. Matt will reach out to set up your hiring workflow.</p>
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    try {
      const { data, error: fnError } = await supabase.functions.invoke("create-hiring-assistant-checkout", {
        body: { ...form },
      });
    ...
    <div className="min-h-screen bg-[#0a0a0f] text-white">
      ...
      <div className="bg-[#0a0a0f] px-6 py-16 text-center border-b border-slate-800">
        ...
        <h1 className="text-3xl md:text-4xl font-black mb-4 leading-tight">
          Hire faster. Screen smarter. Skip the resume pile.
        </h1>
      ...
      <div className="max-w-3xl mx-auto px-6 py-12">
        ...
        <div className="mb-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            {[
              { step: "1", title: "Post Your Job", desc: "Tell us what you're hiring for — AI builds the screening criteria." },
              { step: "2", title: "AI Reviews Applicants", desc: "Every resume gets scored 1-10 against your requirements." },
              { step: "3", title: "Interview the Best", desc: "Top candidates are auto-emailed. You only talk to the winners." },
            ].map((s) => (
