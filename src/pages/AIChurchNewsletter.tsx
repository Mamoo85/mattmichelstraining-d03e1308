...
export default function AIChurchNewsletter() {
  ...
  return (
    <>
      <SEOHead title="AI Church & Nonprofit Newsletter — $29/mo | Detroit Web Agency" description="AI writes your monthly congregation newsletter, weekly bulletin content, and sermon recaps. $29/month — the most affordable ministry tool available." path="/ai-church-newsletter" />
      <div className="min-h-screen bg-[#0f0f1a] text-white">
        <section className="pt-20 pb-16 px-4">
          <div className="max-w-3xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-[#22d3ee]/15 text-[#22d3ee] text-[11px] font-bold tracking-widest uppercase mb-6"><BookOpen size={11} /> AI Church & Nonprofit Newsletter</div>
            <h1 className="text-3xl sm:text-5xl font-black leading-tight mb-5">Your Congregation Deserves<br /><span className="text-[#22d3ee]">a Great Newsletter.</span></h1>
