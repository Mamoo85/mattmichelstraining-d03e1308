...
export default function AiCompetitorReport() {
      ...
      <div className="min-h-screen bg-background flex items-center justify-center px-6">
        <div className="text-center max-w-md">
          ...
          <p className="text-xs text-muted-foreground">
            Questions? <a href="tel:3138064952" className="text-primary font-semibold">(313) 992-1219</a> — Matt picks up.
          </p>
        </div>
      </div>
    );
  ...
  return (
    <>
      <SEOHead
        title="AI Local Competitor Analysis — $9 | Real Google Maps Data | M2 Web Design"
