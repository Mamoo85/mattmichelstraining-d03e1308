...
export default function AIPodcastShowNotes() {
  ...
  return (
    <>
      <SEOHead title="AI Podcast Show Notes — $49/mo | Detroit Web Agency" description="Send us your episode, get back professional show notes, summaries, timestamps, and SEO descriptions. $49/month, fully automated." path="/ai-podcast-show-notes" />
      <div className="min-h-screen bg-[#0a0a0f] text-white">
        <section className="pt-20 pb-16 px-4">
          <div className="max-w-3xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-[#22d3ee]/15 text-[#22d3ee] text-[11px] font-bold tracking-widest uppercase mb-6"><Mic size={11} /> AI Podcast Show Notes</div>
            <h1 className="text-3xl sm:text-5xl font-black leading-tight mb-5">Stop Writing Show Notes.<br /><span className="text-[#22d3ee]">We Do It for $49/month.</span></h1>
