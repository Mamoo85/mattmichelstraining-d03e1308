    ...
    <div className="min-h-screen bg-[#0a0a0f] text-white">
      ...
      <section className="px-6 py-20 text-center max-w-3xl mx-auto">
        ...
        <h1 className="text-4xl sm:text-5xl font-black leading-tight mb-4">
          Fresh Website Copy <span className="text-cyan-500">Every Month</span>
        </h1>
      ...
      <section className="px-6 pb-16 max-w-3xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-6">
          <div className="bg-slate-800 rounded-2xl p-6 border border-slate-700">
            <RefreshCw size={24} className="text-cyan-500 mb-4" />
          ...
          <div className="bg-slate-800 rounded-2xl p-6 border border-slate-700">
            <p className="text-cyan-400 text-xs font-semibold uppercase tracking-widest mb-3">Sample Hero Copy — HVAC</p>
              ...
              <div className="pt-2 border-t border-slate-700">
                ...
                <div className="flex flex-wrap gap-2">
                  {["Same-Day Available", "Flat-Rate Pricing", "10-Year Guarantee"].map(v => (
                    <span key={v} className="text-xs bg-cyan-500/10 text-cyan-400 border border-cyan-500/20 px-2 py-1 rounded-full">{v}</span>
                  ))}
                </div>
              </div>
            </div>
