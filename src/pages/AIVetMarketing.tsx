...
export default function AIVetMarketing() {
  ...
  return (
    <>
      <SEOHead title="AI Marketing for Vet Clinics & Pet Care — $79/mo | Detroit Web Agency" description="AI writes social posts, email newsletters, and review requests for veterinary clinics, groomers, and pet daycares. $79/month." path="/ai-vet-marketing" />
      <div className="min-h-screen bg-[#0f0f1a] text-white">
        <section className="pt-20 pb-16 px-4">
          <div className="max-w-3xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-[#22d3ee]/15 text-[#22d3ee] text-[11px] font-bold tracking-widest uppercase mb-6"><PawPrint size={11} /> AI Vet & Pet Care Marketing</div>
            <h1 className="text-3xl sm:text-5xl font-black leading-tight mb-5">More Pet Owners.<br /><span className="text-[#22d3ee]">Zero Marketing Effort.</span></h1>
