...
const FEATURES = [
  "Executive summary, wins, metrics, next-month plan",
  "Premium, client-ready formatting",
  "Saves 3+ hours per client per month",
];
      ...
      <div className="min-h-screen bg-[#0a0a0f] flex items-center justify-center px-6">
        <div className="text-center max-w-sm">
          ...
          <p className="text-slate-400 leading-relaxed">
            Your monthly client report template will be ready on the first of each month. Check your
            inbox for onboarding details.
          </p>
    ...
    <div className="min-h-screen bg-[#0a0a0f] text-white">
      ...
      <div className="bg-[#0a0a0f] px-6 py-16 text-center border-b border-slate-800">
        ...
        <h1 className="text-3xl md:text-4xl font-black mb-4 leading-tight">
          Send Beautiful Monthly Reports to Your Clients &mdash; AI Writes Them
        </h1>
        <p className="text-slate-400 max-w-xl mx-auto text-sm leading-relaxed mb-6">
          Every month, get a polished, professional report template ready to customize and send to
          your agency clients.
        </p>
        <p className="text-3xl font-black text-cyan-500">
          $59<span className="text-sm font-normal text-slate-400">/mo</span>
        </p>
        ...
        <div className="mb-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            {[
              {
                step: "1",
                title: "Tell Us Your Agency Type",
                desc: "SEO, PPC, social media, web design &mdash; we tailor the report to your services.",
              },
              {
                step: "2",
                title: "AI Builds the Template",
                desc: "A full monthly report template arrives in your inbox on the 1st of every month.",
              },
              {
                step: "3",
                title: "Fill In Numbers, Send",
                desc: "Drop in your client metrics, customize the headline, and send in minutes.",
              },
            ].map((s) => (
        ...
        <Card className="bg-slate-800/50 border-slate-700 mb-10">
          <CardHeader>
            <CardTitle className="text-sm font-black uppercase tracking-widest text-white">
              Get Your First Report Template
            </CardTitle>
          </CardHeader>
          <CardContent>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                <div>
                  ...
                  <Input
                    ...
                    placeholder="e.g. SEO Agency, PPC Agency, Web Design"
                    className="bg-[#0a0a0f] border-slate-700 text-white mt-1"
                  />
                </div>
              </div>
              ...
              >
                ...
                {loading ? "Redirecting to checkout..." : "Subscribe — $59/mo"}
              </Button>
